  ...
  <el-container class="analysis-container" v-if="showContainer">
    <el-aside class="angio-layer-thumbnail-container" width="363px">
      <AngioLayerThumbnails
        :timeStamp="timeStamp"
        :layers="ANGIO_LAYER_THUMBNAIL_LIST"
      />
    </el-aside>
    <el-container>
      <el-container>
...
import AngioLayerThumbnails from "./components/AngioLayerThumbnails.vue";
import AngioImageSettings from "./components/AngioImageSettings.vue";
import AngioImages from "./components/AngioImages.vue";
